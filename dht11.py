...
class DHT11:
	'DHT11 sensor reader class for Odroid'
	...
	def __send_and_sleep(self, output, sleep):
		wpi.digitalWrite(self.__pin, output)
		time.sleep(sleep)
	...
	def __collect_input(self):
		...
		data = []
		while True:
			current = wpi.digitalRead(self.__pin)
			data.append(current)
			if last != current:
				unchanged_count = 0
				last = current
